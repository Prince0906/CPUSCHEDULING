...
Respond with a JSON object in this exact format:
{
  "flaws": [
    {
      "type": "convoy|starvation|context_switches|high_waiting|priority_issue|quantum_inefficiency",
...
- Algorithm types must be one of: fcfs, sjf, srtf, priority, priority-preemptive, rr, mlq
