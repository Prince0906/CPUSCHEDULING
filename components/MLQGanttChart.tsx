...
export default function MLQGanttChart() {
    const { mlqSimState, mlqQueues } = useSchedulerStore();

    const gantt = (mlqSimState?.ganttChart ?? []) as MLQGanttEntry[];
    ...
    return (
        <div className="card">
            <div className="section-header">
                <h2 className="section-title">MLQ Gantt Chart</h2>
